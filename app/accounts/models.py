...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    photo = models.ImageField(upload_to="users", null=True, blank=True, db_index=True)
    surname = models.CharField(max_length=200, null=True, blank=True, db_index=True)
    other_names = models.CharField(max_length=200, null=True, blank=True, db_index=True)
    phone = models.CharField(max_length=20, null=True, blank=True, db_index=True)
    phone_network = models.CharField(max_length=20, null=True, blank=True, db_index=True)
    age = models.IntegerField(blank=True, null=True)
    last_login_date = models.DateTimeField(auto_now=True)
    created_at = models.DateTimeField(default=timezone.now, db_index=True)
    updated_at = models.DateTimeField(auto_now=True, db_index=True)
    wallet = models.OneToOneField("Wallet", related_name="owner", on_delete=models.SET_NULL, null=True, blank=True, db_index=True)
    locale = models.CharField(max_length=20, default="", null=True, blank=True, db_index=True)
    gender = models.CharField(max_length=20, default="", null=True, blank=True, db_index=True)
    recording_environment = models.CharField(max_length=20, default="", null=True, blank=True, db_index=True)
    ...
    created_by = models.ForeignKey("User", related_name="created_users", on_delete=models.PROTECT, null=True, blank=True, db_index=True)
    updated_by = models.ForeignKey("User", related_name="updated_users", on_delete=models.PROTECT, null=True, blank=True, db_index=True)
    estimated_deduction_amount = models.DecimalField(default=0, decimal_places=2, max_digits=20)
    device_ids = models.CharField(max_length=200, null=True, blank=True, db_index=True)
    lead = models.ForeignKey("User", on_delete=models.SET_NULL, null=True, blank=True, db_index=True)
    restricted_audio_count = models.IntegerField(default=10)
    reference_code = models.IntegerField(null=True, blank=True, db_index=True)
